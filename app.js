const list = document.querySelector(".gallery-carousel__images");
const imgs = [...list.children]; // spread operator = Array.from()
...
const hideShowArrows = (imgs, nextButton, prevButton, targetIndex) => {
    if (targetIndex === 0) {
...
nextButton.addEventListener("click", (e) => {
    ...
    hideShowArrows(imgs, nextButton, prevButton, nextIndex);
});
...
prevButton.addEventListener("click", (e) => {
    ...
    hideShowArrows(imgs, nextButton, prevButton, prevIndex);
});
...
carouselNav.addEventListener("click", (e) => {
    ...
    if (!targetDot) return; // stop the function if clicked somewhere else
    ...
    hideShowArrows(imgs, nextButton, prevButton, targetIndex);
